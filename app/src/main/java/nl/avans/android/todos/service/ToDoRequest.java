...
public class ToDoRequest {
    ...
    public void handleGetAllToDos() {
        ...
        if(token != null && !token.equals("dummy default token")) {
            ...
            JsonObjectRequest jsObjRequest = new JsonObjectRequest
                    (Request.Method.GET, Config.URL_LOGIN, null, new Response.Listener<JSONObject>() {
     ...
     */
    public void handlePostToDo(final Film film) {
        ...
        if(token != null && !token.equals("dummy default token")) {
            ...
            //
            String body = "{\"Titel\":\"" + film.getTitle() + "\",\"Year\":\"" + film.getYear() + "\",\"Rating\":\"" + film.getRating() + " + }";
    ...
    public interface ToDoListener {
        ...
        void onToDoAvailable(Film todo);
